...
namespace OrangeShare {
    ...
    public class OrangeStatusIconController {
        ...
        public string StateText = "Welcome to OrangeShare!";
        ...
        public string FolderSize {
            get {
                ...
                foreach (OrangeRepoBase repo in Program.Controller.Repositories)
        ...
        public OrangeStatusIconController ()
        {
            InitAnimation ();
            ...
            Program.Controller.FolderListChanged += delegate {
                if (CurrentState != IconState.Error) {
                    ...
                    if (Program.Controller.Folders.Count == 0)
                        StateText = "Welcome to OrangeShare!";
                    else
        ...
        public void OrangeShareClicked ()
        {
        ...
        {
            Program.Controller.OpenOrangeShareFolder (subfolder);
        }
