...
namespace OrangeShare {
    ...
    public class OrangePlugin {
        ...
        public OrangePlugin (string plugin_path)
        {
        ...
        public static OrangePlugin Create (string name, string description, string address_value,
            string address_example, string path_value, string path_example)
        {
            ...
            return new OrangePlugin (plugin_path);
        }
