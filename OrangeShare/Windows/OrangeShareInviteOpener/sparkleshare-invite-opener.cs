...
namespace OrangeShare {
    ...
    public class OrangeShare {

        public static void Main (string [] args) {

            new OrangeInviteOpen (args [0]);
        }
    }


    public class OrangeInviteOpen {

        public OrangeInviteOpen (string url)
        {
            ...
            string target_path = Path.Combine (home_path, "OrangeShare");
