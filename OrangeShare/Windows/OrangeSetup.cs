            ...
            Controller.ChangePageEvent += delegate (PageType type, string [] warnings) {
                Dispatcher.Invoke ((Action) delegate {
                    ...
                    case PageType.Error: {
						...
						help_block.Inlines.Add ("The host needs to know who you are. Did you upload the key that's in your OrangeShare folder?");
                    ...
                    case PageType.Tutorial: {
                        ...
                        switch (Controller.TutorialPageNumber) {
                            case 1: {
                                ...
                                slide_image.Source = OrangeUIHelpers.GetImageSource ("tutorial-slide-1-windows");
                            ...
                            case 2: {
                                ...
                                slide_image.Source = OrangeUIHelpers.GetImageSource ("tutorial-slide-2-windows");
                            ...
                            case 3: {
                                ...
                                slide_image.Source = OrangeUIHelpers.GetImageSource ("tutorial-slide-3-windows");
                            ...
                            case 4: {
                                ...
                                slide_image.Source = OrangeUIHelpers.GetImageSource ("tutorial-slide-4");
    
                                CheckBox check_box = new CheckBox () {
                                    Content   = "Add OrangeShare to startup items",
                                    IsChecked = true
                                };
