...
namespace OrangeShare {
    ...
    public class OrangeAbout : Window {
        ...
        public OrangeAbout () : base ("")
        {
            ...
            Title          = _("About OrangeShare");
            AppPaintable   = true;

            string image_path = new string [] {OrangeUI.AssetsPath,
        ...
        private void CreateAbout ()
        {
            ...
            Label license = new Label () {
                ...
                Markup       = "<span font_size='small' fgcolor='white'>" +
                               "OrangeShare is Free and Open Source Software. You are free to use, modify, " +
