...
namespace OrangeShare {
            ...
            Controller.ChangePageEvent += delegate (PageType type, string [] warnings) {
                Application.Invoke (delegate {
                    ...
                    case PageType.Setup: {
                        ...
                        Header = _("Welcome to OrangeShare!");
                    ...
                    case PageType.Add: {
                        ...
                        ListStore store = new ListStore (typeof (Gdk.Pixbuf),
                            typeof (string), typeof (OrangePlugin));

                        OrangeTreeView tree = new OrangeTreeView (store) { HeadersVisible = false };
                        ...
                        foreach (OrangePlugin plugin in Controller.Plugins) {
                            store.AppendValues (
                        ...
                        tree.Model.Foreach (new TreeModelForeachFunc (delegate (TreeModel model,
                            ...
                            try {
                                address = (model.GetValue (iter, 2) as OrangePlugin).Address;
                            ...
                            if (!string.IsNullOrEmpty (address) &&
                                ...
                                OrangePlugin plugin = (OrangePlugin) model.GetValue (iter, 2);
                    ...
                    case PageType.Invite: {
                        ...
                        Description = _("Do you want to add this project to OrangeShare?");
                    ...
                    case PageType.Error: {
						...
						Image list_point_one   = new Image (OrangeUIHelpers.GetIcon ("list-point", 16)) {  };
						Image list_point_two   = new Image (OrangeUIHelpers.GetIcon ("list-point", 16)) {  };
						Image list_point_three = new Image (OrangeUIHelpers.GetIcon ("list-point", 16)) {  };
                    ...
                    case PageType.Finished: {
                        ...
                        if (!HasToplevelFocus) {
                            ...
                            string subtext = _("You can find the files in your OrangeShare folder.");

                            OrangeUI.Bubbles.Controller.ShowBubble (title, subtext, null);
                        }

                        Header      = _("Your shared project is ready!");
                        Description = _("You can find it in your OrangeShare folder");
                        ...
                        if (warnings.Length > 0) {
                            Image warning_image = new Image (
                                OrangeUIHelpers.GetIcon ("dialog-info", 24)
                            );
                    ...
                    case PageType.Tutorial: {
                        ...
                        case 1: {
                            ...
                            Image slide = OrangeUIHelpers.GetImage ("tutorial-slide-1.png");
                        ...
                        case 2: {
                            ...
                            Image slide = OrangeUIHelpers.GetImage ("tutorial-slide-2.png");
                        ...
                        case 3: {
                            ...
                            Image slide = OrangeUIHelpers.GetImage ("tutorial-slide-3.png");
                        ...
                        case 4: {
                            ...
                            CheckButton check_button = new CheckButton ("Add OrangeShare to startup items") {
                                Active = true
                            };
    ...
    public class OrangeTreeView : TreeView {
        ...
        public OrangeTreeView (ListStore store) : base (store)
        {
        }
    }
}
