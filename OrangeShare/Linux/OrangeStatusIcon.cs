...
namespace OrangeShare {
    ...
    public class OrangeStatusIcon {
            ...
            Controller.UpdateIconEvent += delegate (int icon_frame) {
                Application.Invoke (delegate {
                    if (icon_frame > -1) {
                        ...
                        #else
						this.status_icon.Pixbuf = OrangeUIHelpers.GetIcon ("sparkleshare-syncing-error", 24);
                        #endif
                    }
                });
            };
        ...
        private void CreateAnimationFrames ()
        {
            ...
            Gdk.Pixbuf frames_pixbuf = OrangeUIHelpers.GetIcon ("process-syncing-sparkleshare", 24);
    ...
    public class OrangeMenuItem : ImageMenuItem {

        public OrangeMenuItem (string text) : base (text)
        {
