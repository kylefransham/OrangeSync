...
namespace OrangeShare {
    ...
    public static class OrangeUIHelpers {
        ...
        public static Gdk.Pixbuf GetIcon (string name, int size)
        {
            ...
            icon_theme.AppendSearchPath (
                Path.Combine (OrangeUI.AssetsPath, "icons")
            );

            icon_theme.AppendSearchPath (
                Path.Combine (Path.GetDirectoryName (OrangeConfig.DefaultConfig.FullPath), "icons")
            );
        ...
        {
            string image_path = OrangeHelpers.CombineMore (Defines.DATAROOTDIR, "sparkleshare",
                "pixmaps", name);
