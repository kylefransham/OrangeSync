...
namespace OrangeShare {
    ...
    public class OrangeSetupWindow : Window    {
        ...
        public OrangeSetupWindow () : base ("")
        {
            Title          = Catalog.GetString ("OrangeShare Setup");
            BorderWidth    = 0;
            ...
            SecondaryTextColor = OrangeUIHelpers.GdkColorToHex (Style.Foreground (StateType.Insensitive));
                        
            SecondaryTextColorSelected =
                OrangeUIHelpers.GdkColorToHex (
                    MixColors (
            ...
            HBox = new HBox (false, 0);
                ...
                Image side_splash = OrangeUIHelpers.GetImage ("side-splash.png");
