...
namespace OrangeShare {
    ...
    public class OrangeAbout : NSWindow {

        public OrangeAboutController Controller = new OrangeAboutController ();
        ...
        public OrangeAbout (IntPtr handle) : base (handle) { }

        public OrangeAbout () : base ()
        {
            using (var a = new NSAutoreleasePool ())
            {
                ...
                Delegate    = new OrangeAboutDelegate ();
                StyleMask   = (NSWindowStyle.Closable | NSWindowStyle.Titled);
                Title       = "About OrangeShare";
            ...
            using (var a = new NSAutoreleasePool ())
            {
                ...
                this.credits_text_field = new NSTextField () {
                    StringValue     = @"Copyright © 2010–" + DateTime.Now.Year + " Hylke Bons and others." +
                                       "\n" +
                                       "\n" +
                                       "OrangeShare is Free and Open Source Software. You are free to use, modify, and redistribute it " +
    ...
    public class OrangeAboutDelegate : NSWindowDelegate {
        
        public override bool WindowShouldClose (NSObject sender)
        {
            (sender as OrangeAbout).Controller.WindowClosed ();
            return false;
        }
    }
}
