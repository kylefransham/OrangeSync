...
namespace OrangeShare {
    ...
    public class OrangeStatusIcon : NSObject {
        ...
        public void CreateMenu ()
        {
            using (NSAutoreleasePool a = new NSAutoreleasePool ())
            {
                ...
                this.menu.Delegate    = new OrangeStatusIconMenuDelegate ();
    ...
    public class OrangeStatusIconMenuDelegate : NSMenuDelegate {
