...
namespace OrangeShare {
    ...
    public class OrangeBubbles : NSObject {

        public OrangeBubblesController Controller = new OrangeBubblesController ();


        public OrangeBubbles ()
        {
