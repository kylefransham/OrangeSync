...
namespace OrangeShare {
    ...
    public class OrangeSetup : OrangeSetupWindow {

        public OrangeSetupController Controller = new OrangeSetupController ();
        ...
        private OrangeDataSource DataSource;


        public OrangeSetup () : base ()
        {
                    ...
                    InvokeOnMainThread (delegate {
                        ...
                        case PageType.Setup: {
                            ...
                            FullNameTextField = new NSTextField () {
                                ...
                                Delegate    = new OrangeTextFieldDelegate ()
                            };
                            ...
                            (FullNameTextField.Delegate as OrangeTextFieldDelegate).StringValueChanged += delegate {
                            ...
                            (EmailTextField.Delegate as OrangeTextFieldDelegate).StringValueChanged += delegate {
                                Controller.CheckSetupPage (
                                    FullNameTextField.StringValue,
                                    EmailTextField.StringValue
                                );
                        ...
                        case PageType.Invite: {
                            ...
                            Description = "Do you want to add this project to OrangeShare?";
                        ...
                        case PageType.Add: {
                            ...
                            TableView = new NSTableView () {
                                ...
                                HeaderView       = null,
                                Delegate         = new OrangeTableViewDelegate ()
                            };
                            ...
                            DataSource = new OrangeDataSource (Controller.Plugins);
                            ...
                            (AddressTextField.Delegate as OrangeTextFieldDelegate).StringValueChanged += delegate {
                             ...
                             (PathTextField.Delegate as OrangeTextFieldDelegate).StringValueChanged += delegate {
                                Controller.CheckAddPage (
                                    AddressTextField.StringValue,
                                    PathTextField.StringValue,
                                    TableView.SelectedRow
                            ...
                            (TableView.Delegate as OrangeTableViewDelegate).SelectionChanged += delegate {
                        ...
                        case PageType.Error: {
                            ...
                            string html = "<style>" +
                                ...
                                "  <li>The host needs to know who you are. Did you upload the key that's in your OrangeShare folder?</li>" +
                                "</ul>";
                        ...
                        case PageType.CryptoSetup: {
                            ...
                            (PasswordTextField.Delegate as OrangeTextFieldDelegate).StringValueChanged += delegate {
                            ...
                            (VisiblePasswordTextField.Delegate as OrangeTextFieldDelegate).StringValueChanged += delegate {
                        ...
                        case PageType.Finished: {
                            ...
                            Description = "You can find the files in your OrangeShare folder.";
                        ...
                        case PageType.Tutorial: {
                            ...
                            case 1: {
                                ...
                                Description = "OrangeShare creates a special folder on your computer " +
                            ...
                            case 4: {
                                Header      = "Adding projects to OrangeShare";
                                ...
                                StartupCheckButton = new NSButton () {
                                    Frame = new RectangleF (190, Frame.Height - 400, 300, 18),
                                    Title = "Add OrangeShare to startup items",
    ...
    [Register("OrangeDataSource")]
    public class OrangeDataSource : NSTableViewDataSource {
        ...
        public OrangeDataSource (List<OrangePlugin> plugins)
        {
            ...
            int i = 0;
            foreach (OrangePlugin plugin in plugins) {
                Items.Add (plugin);
            ...
            NSTableColumn table_column, int row_index)
        {
            if (table_column.HeaderToolTip.Equals ("Description")) {
                if (table_view.SelectedRow == row_index &&
                    OrangeUI.Setup.IsKeyWindow &&
                    OrangeUI.Setup.FirstResponder == table_view) {
                ...
                return new NSImage ((Items [row_index] as OrangePlugin).ImagePath) {
    ...
    public class OrangeTextFieldDelegate : NSTextFieldDelegate {
    ...
    public class OrangeTableViewDelegate : NSTableViewDelegate {
