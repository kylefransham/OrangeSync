...
namespace OrangeLib {
    ...
    public class OrangeListenerTcp : OrangeListenerBase {
        ...
        public OrangeListenerTcp (Uri server, string folder_identifier) :
                    ...
                    while (this.is_connected) {
                        try {
                            ...
                            while (this.socket.Available < 1) {
                                try {
                                    ...
                                    if (i == 180) {
                                        OrangeHelpers.DebugInfo ("ListenerTcp",
                                            "Pinging " + Server);
                        ...
                        if (bytes_read > 0) {
                            ...
                            if (!folder_identifier.Equals ("debug") &&
                                ...
                                // We have a message!
                                OnAnnouncement (new OrangeAnnouncement (folder_identifier, message));
                            }
                        }
                    }
                })
        ...
        protected override void AnnounceInternal (OrangeAnnouncement announcement)
        {
