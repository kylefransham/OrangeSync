...
namespace OrangeLib {
    ...
    public class OrangeConfig : XmlDocument {

        private static string default_config_path = Path.Combine (
            Environment.GetFolderPath (Environment.SpecialFolder.ApplicationData),
                "sparkleshare");

        public static OrangeConfig DefaultConfig = new OrangeConfig (default_config_path, "config.xml");
        ...
        public string HomePath {
            get {
                ...
                else if (OrangeHelpers.IsWindows)
        ...
        public string FoldersPath {
            get {
                if (GetConfigOption ("folders_path") != null)
                    ...
                    return Path.Combine (HomePath, "OrangeShare");
            }
        }


        public OrangeConfig (string config_path, string config_file_name)
        {
            try {
                ...
                string old_path = Path.Combine (
                    Environment.GetFolderPath (Environment.SpecialFolder.Personal), "OrangeShare");

                if (Directory.Exists (old_path) &&
                    Environment.OSVersion.Platform == PlatformID.Win32NT) {

                    string new_path = Path.Combine (Environment.GetFolderPath (folder), "OrangeShare");
                    Directory.Move (old_path, new_path);

                    Console.WriteLine ("Migrated OrangeShare folder to %USERPROFILE%");
                }
        ...
        private void CreateInitialConfig ()
        {
            ...
            if (OrangeBackend.Platform == PlatformID.Unix ||
                OrangeBackend.Platform == PlatformID.MacOSX) {
        ...
        public OrangeUser User {
            get {
                ...
                OrangeUser user = new OrangeUser (name, email);
            ...
            set {
                OrangeUser user = (OrangeUser) value;
        ...
        public void SetConfigOption (string name, string content)
        {
            ...
            OrangeHelpers.DebugInfo ("Config", "Updated " + name + ":" + content);
            Save ();
        }
        ...
        private void Save ()
        {
            ...
            Save (FullPath);
            OrangeHelpers.DebugInfo ("Config", "Updated \"" + FullPath + "\"");
        }
    }
