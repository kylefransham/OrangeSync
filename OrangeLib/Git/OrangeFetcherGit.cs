...
namespace OrangeLib.Git {

    // Sets up a fetcher that can get remote folders
    public class OrangeFetcher : OrangeFetcherBase {

        private OrangeGit git;
        private string crypto_salt = "e0d592768d7cf99a"; // TODO: Make unique per repo


        public OrangeFetcher (string server, string required_fingerprint, string remote_path,
        ...
        public override bool Fetch ()
        {
            if (FetchPriorHistory) {
                this.git = new OrangeGit (OrangeConfig.DefaultConfig.TmpPath,
                    "clone " +
                    "--progress " +
                    "--no-checkout " +
                    "--depth=1 " +
            ...
            while (!this.git.StandardError.EndOfStream) {
                ...
                if (match.Success) {
                    ...
                    OrangeHelpers.DebugInfo ("Fetcher", line);
                }
            ...
            OrangeHelpers.DebugInfo ("Git", "Exit code: " + this.git.ExitCode);
        ...
        public override bool IsFetchedRepoEmpty {
            get {
                OrangeGit git = new OrangeGit (TargetFolder, "rev-list --reverse HEAD");
                git.Start ();
        ...
        public override void EnableFetchedRepoCrypto (string password)
        {
            ...
            string repo_config_file_path = OrangeHelpers.CombineMore (TargetFolder, ".git", "config");
            ...
            string git_attributes_file_path = OrangeHelpers.CombineMore (
            ...
            // Store the password
            string password_file_path = OrangeHelpers.CombineMore (TargetFolder, ".git", "password");
        ...
        public override void Stop ()
        {
            try {
                ...
                OrangeHelpers.DebugInfo ("Fetcher", "Failed to dispose properly: " + e.Message);
            }
        }
        ...
        private void InstallConfiguration ()
        {
            ...
            File.WriteAllText (repo_config_file_path, config);
            OrangeHelpers.DebugInfo ("Fetcher", "Added configuration to '" + repo_config_file_path + "'");
        }
        ...
        private void InstallExcludeRules ()
        {
            DirectoryInfo info = Directory.CreateDirectory (
                OrangeHelpers.CombineMore (TargetFolder, ".git", "info"));
